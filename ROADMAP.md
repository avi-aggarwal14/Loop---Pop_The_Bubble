...
## Phase 9 — Demo polish
- [x] **[ME]** Added synthetic Shopify pull endpoint for the demo video: `/api/demo/shopify-pull`, backed by `lib/demo/shopify-synthetic.ts`, plus `demo/shopify-demo-video-brief.md` with the narrative.
